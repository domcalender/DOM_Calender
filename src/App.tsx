  ...
  const events: Event[] = [
    {
      ...
      category: "Workshop",
      startDateTime: new Date(2025, 7, 24, 15, 0).toISOString(),
      endDateTime: new Date(2025, 7, 24, 16, 0).toISOString(),
    },
    {
      id: 2,
      ...
      startDateTime: new Date(2025, 7, 28, 17, 0).toISOString(),
      endDateTime: new Date(2025, 7, 28, 19, 0).toISOString(),
    },
    {
      id: 3,
      title: "BOSM 2025",
      ...
      posterUrl: bosm,
      category: "Festival",
      startDateTime: "2025-09-17",
      endDateTime: "2025-09-21",
    },
    {
      id: 4,
      ...
      category: "Seminar",
      startDateTime: new Date(2025, 8, 27, 11, 30).toISOString(),
      endDateTime: new Date(2025, 8, 27, 13, 30).toISOString(),
    },
    {
      id: 5,
      ...
      startDateTime: new Date(2025, 9, 12, 17, 0).toISOString(),
      endDateTime: new Date(2025, 9, 12, 19, 0).toISOString(),
    },
    {
      id: 6,
      title: "Interface",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full flex flex-col items-center justify-center py-8">
        <h2 className="text-4xl font-extrabold mb-4 text-blue-900 tracking-wide">
          Event Calendar
        </h2>
        ...
        <div className="w-full lg:max-w-md">
          ...
          <div className="grid grid-cols-7 gap-2 bg-white rounded-lg shadow p-4">
            {["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map(day => (
              <div key={day} className="text-xs font-semibold text-gray-500 text-center mb-2">
                {day}
              </div>
            ))}
                  ...
                  {isEvent && (
                    <span className="flex gap-1 mt-2">
                      ...
                      {eventsForDate.length > 3 && (
                        <span className={`text-[10px] ${isSelected ? 'text-white' : 'text-blue-900'} ml-1`}>
                          +{eventsForDate.length - 3}
                        </span>
                      )}
                    </span>
          ...
          <div className="space-y-3">
            {(() => {
              ...
              const eventToDisplay =
                eventsForSelected.find(ev => ev.id === selectedEventId) ||
                eventsForSelected[0];
              ...
              return (
                <>
                  ...
                  <div className="bg-white rounded-lg shadow p-6 border border-blue-100">
                    ...
                    {eventToDisplay.speaker && (
                      <div className="mb-2 text-gray-700"><strong>Speaker:</strong> {eventToDisplay.speaker}</div>
                    )}
                    <div className="mb-2 text-gray-700"><strong>Category:</strong> {eventToDisplay.category}</div>

                    <button
                      className="mt-4 bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200"
